...
namespace Photon.Realtime
{
    ...
    public class Player
    {
        ...
        public string NickName2
        {
            ...
            set
            {
                if (!string.IsNullOrEmpty(this.nickName2) && this.nickName2.Equals(value))
                {
                    return;
                }
        ...
        private bool SetPlayerNameProperty2()
        {
            if (this.RoomReference != null && !this.RoomReference.IsOffline)
            {
                Hashtable properties = new Hashtable();
                properties[ActorProperties.PlayerName] = this.nickName2;
                return this.RoomReference.LoadBalancingClient.OpSetPropertiesOfActor(this.ActorNumber, properties);
            }
